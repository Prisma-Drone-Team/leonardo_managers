...
schema(manage\Agent\devices,[
	[solve(rover.command,string,Agent/command,1.0),0,["TRUE"]],
	[solve(rover.sensor,string,Agent/s2,1.0),0,["TRUE"]] ],
	[],
	[] ).
...
schema(inspect(Sensor,Point),[
	[compete(rover.command,string,exe_goto\Point\visual,0.1),0,["TRUE"]],
	[scan_directly(Sensor,Point),0,[Point.reached]] ],
	[Point.inspected],
	[distance(Point)] ).
	
schema(scan_directly(Sensor,Point),[
	[compete(rover.command,string,wait,0.1),0,["TRUE"]],
	[compete(rover.sensor,string,exe_scan\Sensor\Point,0.1),0,["TRUE"]],
	%[state(Point.inspected,seed/state),0,[scan(Sensor,Point).done]] ],
	[remember( state(Point.inspected,seed/state), memory ),0,[scan(Sensor,Point).done]] ],
	[Point.inspected],
	[] ).
...
schema(requestStream, [[inspect(s2,p1),0,["TRUE"]], [inspect(s2,p2),0,["TRUE"]], [inspect(s2,p3),0,["TRUE"]], [gui,0,["TRUE"]] ], [], [] ).
%%--
