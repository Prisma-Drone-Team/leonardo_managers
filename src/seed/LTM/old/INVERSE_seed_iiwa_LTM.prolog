...
schema(iiwaUnstack(Obj1,FromObj2,ToObj3), [
	[hardSequence([iiwaDetach(Obj1,FromObj2),iiwaWait(w0),iiwaPut(Obj1,ToObj3)]), 0, ["TRUE"] ] ], 
	[], []).


schema(iiwaStack(Obj1,FromObj2,ToObj3), [
	[hardSequence([iiwaPick(Obj1,FromObj2),iiwaWait(w0),iiwaAttach(Obj1,ToObj3)]), 0, ["TRUE"] ] ], 
	[], []).
...
%	[Obj.taken], []).
schema(iiwaPick(Obj1,FromObj2), [
	[hardSequence([iiwaGo(FromObj2.pre),iiwaGo(FromObj2),iiwaWait(w1),wsg50Grasp(Obj1),iiwaGo(FromObj2.pre),iiwaGo(home),timer(Obj1.taken,true,0.1)]), 0, ["TRUE"] ] ], 
	[Obj1.taken], []).

	
schema(iiwaPut(Obj1,OnObj2), [
	[hardSequence([iiwaGo(any,OnObj2.pre),iiwaGo(OnObj2.pre,OnObj2.over),iiwaWait(w3),wsg50Release(Obj1),iiwaGo(home),timer(on(Obj1,OnObj2),true,0.1)]), 0, ["TRUE"] ] ], 
	[on(Obj1,OnObj2)], []).



schema(iiwaAttach(Obj1,OnObj2), [
	[hardSequence([iiwaGo(any,OnObj2.pre),iiwaWait(w2),iiwaInsert(Obj1,OnObj2.over),iiwaWait(w3),wsg50Release(Obj1),iiwaGo(OnObj2.over,home),timer(on(Obj1,OnObj2),true,0.1)]), 0, ["TRUE"] ] ], 
	[on(Obj1,OnObj2)], []).
	
schema(iiwaDetach(Obj1,FromObj2), [
	[hardSequence([iiwaGo(any,Obj1.pre),iiwaGo(Obj1.pre,Obj1),iiwaWait(w2),wsg50Grasp(Obj1),iiwaExtract(Obj1,FromObj2.pre),iiwaWait(w3),iiwaGo(FromObj2.pre,home),timer(Obj1.taken,true,0.1)]), 0, ["TRUE"] ] ], 
	[Obj1.taken], []).
...
% result of invert(iiwaStack(brick21,brick20),INV) modifying  iiwaGo(home,brick21) -> iiwaGo(home,rnd)
schema(-iiwaPick(brick21),
	[[hardSequence([
		timer(brick21.taken,true,0.1),
		%iiwaGo(home,brick21),
		wsg50Release(brick21),
		iiwaWait(w1),
		iiwaGo(brick21,brick21.pre),
		iiwaGo(brick21.pre,home)]),0,[TRUE]]],[],[]).

schema(-iiwaAttach(brick21,brick20),
	[[hardSequence([
		timer(on(brick21,brick20),true,0.1),
		iiwaGo(home,brick20.over),
		wsg50Grasp(brick21),
		iiwaWait(w3),
		iiwaExtract(brick21,brick20.over),
		iiwaWait(w2),
		iiwaGo(brick20.pre,home)]),0,[TRUE]]],[],[]).
